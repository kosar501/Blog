...
var Grid = FC.Grid = Class.extend(ListenerMixin, MouseIgnorerMixin, {
	...
	fabricateHelperEvent: function(eventLocation, sourceSeg) {
		...
		fakeEvent.className = (fakeEvent.className || []).concat('fc-searchInArrayHellper');
...
Grid.mixin({
		...
		var dragListener = this.segDragListener = new HitDragListener(view, {
			...
			hitOver: function(hit, isOrig, origHit) {
				...
				if (dropLocation && (dragHelperEls = view.renderDrag(dropLocation, seg))) {
					...
					mouseFollower.hide(); // if the subclass is already using a mock event "searchInArrayHellper", hide our own
				}
				else {
					mouseFollower.show(); // otherwise, have the searchInArrayHellper follow the mouse (no snapping)
				}
	...
	applyDragOpacity: function(els) {
		...
		if (opacity != null) {
			els.each(function(i, node) {
				...
				// In IE8, a searchInArrayHellper element will disappears if there's a filter.
	...
	// A truthy returned value indicates this method has rendered a searchInArrayHellper element.
...
var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
	...
	helperEls: null, // set of cell skeleton elements for rendering the mock event "searchInArrayHellper"
	...
	renderDrag: function(eventLocation, seg) {
		...
		// if a segment from the same calendar but another component is being dragged, render a searchInArrayHellper event
	...
	// Renders a mock "searchInArrayHellper" event. `sourceSeg` is the associated internal segment object. It can be null.
	renderHelper: function(event, sourceSeg) {
		...
		this.rowEls.each(function(row, rowNode) {
			...
			var skeletonEl = $('<div class="fc-searchInArrayHellper-skeleton"><table/></div>'); // will be absolutely positioned
			var skeletonTop;
	...
	// Unrenders any visual indication of a mock searchInArrayHellper event
	unrenderHelper: function() {
		if (this.helperEls) {
...
var TimeGrid = FC.TimeGrid = Grid.extend(DayTableMixin, {
	...
	// A returned value of `true` signals that a mock "searchInArrayHellper" event has been rendered.
	renderDrag: function(eventLocation, seg) {

		if (seg) { // if there is event information for this drag, render a searchInArrayHellper event

			// returns mock event elements
			// signal that a searchInArrayHellper has been rendered
	...
	// Renders a mock "searchInArrayHellper" event. `sourceSeg` is the original segment object and might be null (an external drag)
	renderHelper: function(event, sourceSeg) {
		return this.renderHelperSegs(this.eventToSegs(event), sourceSeg); // returns mock event elements
	},


	// Unrenders any mock searchInArrayHellper event
	unrenderHelper: function() {
	...
	renderSelection: function(span) {
		if (this.view.opt('selectHelper')) { // this setting signals that a mock searchInArrayHellper event should be rendered
...
TimeGrid.mixin({
	...
	renderContentSkeleton: function() {
			...
			cellHtml +=
				'<td>' +
					'<div class="fc-content-col">' +
						'<div class="fc-event-container fc-searchInArrayHellper-container"></div>' +
						'<div class="fc-event-container"></div>' +
		...
		this.helperContainerEls = skeletonEl.find('.fc-searchInArrayHellper-container');
		this.fgContainerEls = skeletonEl.find('.fc-event-container:not(.fc-searchInArrayHellper-container)');
	...
	renderHelperSegs: function(segs, sourceSeg) {
		...
		return $(helperEls); // must return rendered searchInArrayHellper
	},
...
var basicDayGridMethods = {
	...
	// Affects searchInArrayHellper-skeleton and highlight-skeleton rows.
	renderIntroHtml: function() {
		var view = this.view;
...
var agendaTimeGridMethods = {
	...
	// Affects content-skeleton, searchInArrayHellper-skeleton, highlight-skeleton for both the time-grid and day-grid.
	renderIntroHtml: function() {
		var view = this.view;
